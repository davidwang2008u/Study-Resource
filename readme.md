...
#### 总结
- [机器学习各类算法总结](https://www.cnblogs.com/pinard/category/894692.html)
* [北大图书馆](https://github.com/lib-pku/libpku)

### 自然语言处理

#### 中文自然语言处理资料库
-[中文资料](https://github.com/davidwang2008u/Awesome-Chinese-NLP)
...
- [CNN文本分类](https://github.com/dennybritz/cnn-text-classification-tf)

#### Base Tools
- [NLTK](https://github.com/nltk/nltk)
- stanford nlp
  - [Stanford CoreNLP: A Java suite of core NLP tools](https://github.com/stanfordnlp/CoreNLP)
  - [Official Stanford NLP Python Library for Many Human Languages](https://github.com/stanfordnlp/stanfordnlp)
  - [Official Python interface to CoreNLP using a bidirectional server-client interface.](https://github.com/stanfordnlp/python-stanford-corenlp)
- [LTP 哈工大语言技术平台](https://github.com/HIT-SCIR/ltp)
...
- [范例项目,Java开发,内容不多](https://github.com/davidwang2008u/intellide-graph)
...
- [NER topics](https://github.com/topics/named-entity-recognition)
...
- [coreNLP](https://nlp.stanford.edu/software/crf-faq.shtml)
- [基于tensorflow深度学习的中文的命名实体识别](https://github.com/shiyybua/NER)
- [中文NER](https://github.com/zjy-ucas/ChineseNER)

#### NRE
- [OpenNER](https://github.com/davidwang2008u/OpenNRE) [fork from OpenNER](https://github.com/thunlp/OpenNRE)
- [Relation Extraction关系抽取 TOPIC](https://github.com/topics/relation-extraction)
- [中文信息抽取](https://github.com/davidwang2008u/Information-Extraction-Chinese)
- [上面链接的Fork来源](https://github.com/crownpku/Information-Extraction-Chinese)
...
- [BERT属性抽取](https://github.com/sakuranew/BERT-AttributeExtraction)

#### Coreference Resolution 
- [共指消解](https://github.com/huggingface/neuralcoref)
...
- [语法知识图谱](https://github.com/careerbuilder/semantic-knowledge-graph)
...
- [Awesome语义抽取](https://github.com/ksluckow/awesome-symbolic-execution)
- [GloVec](https://github.com/eclipse-du/glove_py_model_load/blob/master/glove_dist.py)


#### HanLP
- [自然语言处理 中文分词 词性标注 命名实体识别 依存句法分析 新词发现 关键词短语提取 自动摘要 文本分类聚类 拼音简繁](https://github.com/davidwang2008u/HanLP)
- [HankCS/HanLP](https://github.com/hankcs/HanLP)
- [HanLP中文分词Lucene插件，支持包括Solr在内的基于Lucene的系统](https://github.com/hankcs/hanlp-lucene-plugin)
- [HanLP Python接口](https://github.com/hankcs/pyhanlp)
...
#### 资料
- [Notes](https://github.com/davidwang2008u/deep-learning-notes)
- [Fast and flexible AutoML with learning guarantees.](https://github.com/tensorflow/adanet)
...
- [CNN LSTM](https://github.com/watsonyanghx/CNN_LSTM_CTC_Tensorflow)

#### R-CNN 对象检测
- [异常/不规则检测的资源](https://github.com/davidwang2008u/anomaly-detection-resources)
- [Awesome AR](https://github.com/davidwang2008u/awesome-action-recognition)
...
- [Awesome DL of Music](https://github.com/ybayle/awesome-deep-learning-music)
- [ECCV18 Workshops - Enhanced SRGAN. Champion PIRM Challenge on Perceptual Super-Resolution (Third Region)](https://github.com/xinntao/ESRGAN)
...
### 图片视频语音处理
- [OpenCV](https://github.com/davidwang2008u/opencv)
